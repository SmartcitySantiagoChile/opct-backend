    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "access_to_ops",
                    models.BooleanField(
                        default=False, verbose_name="Acceso a Programas de Operación"
                    ),
                ),
                (
                    "access_to_organizations",
                    models.BooleanField(
                        default=False, verbose_name="Acceso a Organizaciones"
                    ),
                ),
                (
                    "access_to_users",
                    models.BooleanField(
                        default=False, verbose_name="Acceso a Usuarios"
                    ),
                ),
                (
                    "groups",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="+",
                        to="rest_api.changeoprequeststatus",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_threshold",
                    models.IntegerField(verbose_name="Días máximos antes de nuevo PO"),
                ),
                (
                    "contract_type",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_at",
                    models.DateField(unique=True, verbose_name="Fecha de inicio"),
                ),
                (
                    "op_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="ops",
                        to="rest_api.operationprogramtype",
                        verbose_name="Tipo de Programa de Operación",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="rest_api.changeoprequestmessage",
