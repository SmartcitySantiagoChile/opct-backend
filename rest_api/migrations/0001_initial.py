    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='+', to='rest_api.operationprogramstatus', verbose_name='Estado nuevo')),
                ('previous_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='status_logs', to='rest_api.operationprogramstatus', verbose_name='Estado previo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('op_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organizations', to='rest_api.operationprogramtype', verbose_name='Tipo de Programa de Operación')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='changeoprequest',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='change_op_requests', to='rest_api.operationprogramstatus', verbose_name='Estado'),
        ),
        migrations.AddField(
            model_name='user',
            name='organization',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='rest_api.organization', verbose_name='Organización'),
        ),
        migrations.AddField(
            model_name='user',
