...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            nargs="+",
            type=int,
            help="list of user ids. For instance: user_obj.pk ...",
        )
        parser.add_argument(
            "--sync", action="store_true", help="send email whithout worker"
        )
    ...
    def handle(self, *args, **options):
        ...
        job_execution_obj = SendMailJobExecution.objects.create(
